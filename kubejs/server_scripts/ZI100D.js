ServerEvents.recipes(event => {
  ...
  event.remove({ id: 'numismatic-overhaul:shop' })
  event.shapeless(Item.of('patchouli:guide_book', '{"patchouli:book":"patchouli:notebook"}'),
    ['minecraft:book', 'minecraft:rotten_flesh'])
})

LootJS.modifiers(event => {
  const drop_coin = ['zombie', 'drowned', 'zoglin', 'zombie_villager', 'zombified_piglin']
  const remove_loot = ['#forge:tools', '#forge:weapons', 'map']
  // const remove_loot = ['wooden_sword', 'wooden_shovel', 'wooden_axe', 'wooden_pickaxe', 'wooden_hoe']
  event
